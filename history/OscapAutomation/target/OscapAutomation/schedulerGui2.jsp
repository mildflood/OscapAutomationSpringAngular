...
<div class="form-group"><input type="text" class="form-control" placeholder="Search By nodename" name="nodename"></div>
...
<!-- Schedule Modal -->
 ...
 <form class="form-inline"  id="scanhostForm" onsubmit="return submitForm();">  
...
<div class="form-group">
      ...
      <select class="form-control" name="repeatAction" id="repeatAction">
