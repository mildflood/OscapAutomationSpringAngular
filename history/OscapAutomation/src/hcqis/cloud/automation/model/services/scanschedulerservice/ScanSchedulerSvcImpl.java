...
public class ScanSchedulerSvcImpl implements IScanSchedulerSvc { 
	...
	private void retrieveReports(String nodeName) {  
	  ...
	  //String OScmd = new String("/usr/bin/sudo"+ " " +"/usr/bin/scp ansible@" + nodeName + ":" + "/home/ansible/*.html   /tmp/myDump"); 
	   ...
	   String OScmd = new String("/bin/bash -x"  + " " + "/home/oscapscn/getThemAll.bash" + " " + nodeName);
		logger.info(OScmd);
